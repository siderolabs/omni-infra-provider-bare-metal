...
# XCORR experiment (DO NOT MERGE): pin omni to the instrumented POST-lifecycle build WITH Oguz's fix
# (hold maintenance op until system disk observed). The docker pull below keeps it fresh.
OMNI_IMAGE=ghcr.io/utkuozdemir/omni:xcorr-post-fix
