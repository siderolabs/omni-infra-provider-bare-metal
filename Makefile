...
#
# Generated on 2024-11-28T22:55:22Z by kres 232fe63.
...
run-integration-test: provider qemu-up
	TEMP_REGISTRY=$(TEMP_REGISTRY) OMNI_IMAGE=$(OMNI_IMAGE) OMNI_INTEGRATION_TEST_IMAGE=$(OMNI_INTEGRATION_TEST_IMAGE) hack/test/integration.sh
