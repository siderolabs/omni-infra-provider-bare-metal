...
replace github.com/pin/tftp/v3 => github.com/utkuozdemir/pin-tftp/v3 v3.0.0-20241021135417-0dd7dba351ad
...
require (
	...
	github.com/siderolabs/omni/client v0.0.0-20250210135740-6fb1fcd5dfd5
